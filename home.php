   ...
   <script type="text/javascript">
        (function(d, m){
            var kommunicateSettings =
                {"appId":"1e09b51788dd98db478a141f31644695a","popupWidget":true,"automaticChatOpenOnNavigation":true};
...
<section class="footer">
   <div class="box-container">
      ...
      <div class="box">
         ...
         <a href="#"> <i class="fas fa-envelope"></i> Travel2024@gmail.com </a>
         <a href="#"> <i class="fas fa-map"></i> West Bangal, Kol-700122 </a>
      </div>
      <div class="box">
         <h3>follow us</h3>
   ...
   <div class="credit"> designed by <span>Group 13</span> | all rights reserved! </div>
</section>
<!-- footer section ends -->
<!-- swiper js link  -->
